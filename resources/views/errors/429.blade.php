...
<head>
    ...
    <title>Too Many Requests | Prime Trade Access</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .orb-2{width:300px;height:300px;background:#EAB308;bottom:-80px;right:-80px;animation-delay:3s}
        @keyframes float{0%,100%{transform:translateY(0) scale(1)}50%{transform:translateY(-30px) scale(1.05)}}
        .container{text-align:center;z-index:10;padding:40px;max-width:600px}
        .error-code{font-size:140px;font-weight:800;background:linear-gradient(135deg,#F97316,#EAB308);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;line-height:1;margin-bottom:8px}
        ...
        .btn-primary{background:linear-gradient(135deg,#F97316,#EAB308);color:#fff;box-shadow:0 4px 20px rgba(249,115,22,.3)}
...
<body>
    ...
    <div class="container">
        ...
        <p>You've made too many requests in a short time. Take a breather and try again in a moment — we'll be right here waiting!</p>
        <div class="btn-group">
